    ...
    <div className="grid place-items-center">
      <div className="w-10/12 p-12 bg-white sm:w-8/12 md:w-1/2 lg:w-6/12">
        ...
        <form onSubmit={handleSubmit} className="mt-6">
          <select
            className="block w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-6 rounded shadow leading-tight focus:outline-none focus:shadow-outline cursor-pointer "
            value={selectedBank}
        ...
        {displayedCode && (
          <div className="flex justify-center text-center">
            <p className="mt-2 font-bold text-lg">
              Dial {displayedCode} to check your account balance
            </p>
          </div>
        )}
      </div>
